...
A <- sort(exp(rnorm(10000, 4, 0.25)))
B <- sort(exp(rnorm(10000, 5, 0.25)))
par(mfrow = c(2, 1))
plot(density(log(c(A, B))), xlab = "log Concentration", col = "black", lwd = 2, main = NULL)
lines(density(log(A)), col = "blue", lwd = 1)
lines(density(log(B)), col = "red", lwd = 1)
plot(density(log(A)), xlab = "log Concentration", col = "blue", lwd = 1.5, main = "log-Transformed Data")
```
